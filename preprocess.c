...
void init_macros(void)
{
  ...
  define_macro("USHRT_MAX", "65535");
  define_macro("UINT_MAX", "4294967295U");
  define_macro("ULONG_MAX", "4294967295UL");
  define_macro("LONG_MAX", "2147483647L");
