...
int main () {
 // --- ROTR test ---
  SHA_LONG64 x = 0x0123456789ABCDEFULL;

  SHA_LONG64 r = ROTR(x, 8);

  // Expected: rotate right by 8
  ASSERT(0xEF0123456789ABCDULL, r);

  // --- PULL64 test ---
  SHA_LONG64 y = 0x1122334455667788ULL;

  SHA_LONG64 z = PULL64(y);

  // Expected: byte swap
  ASSERT(0x8877665544332211ULL, z);
