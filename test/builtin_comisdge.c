...
int main(void) {
    ...
    int result = __builtin_ia32_comisdge(v1, v2);
    printf("result = %d\n", result);
    ASSERT(0, result);

    result =  __builtin_ia32_comisdge(v1, v3);
    printf("result = %d\n", result);
    ASSERT(0, result);
    result =  __builtin_ia32_comisdge(vnan, v1);
    printf("result = %d\n", result);
    ASSERT(1, result);
    result =  __builtin_ia32_comisdge(v1, vnan);
    printf("result = %d\n", result);
    ASSERT(0, result);
    result =  __builtin_ia32_comisdge(vnan, vnan);
    printf("result = %d\n", result);
    ASSERT(1, result);
