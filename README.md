...
libwepb: https://github.com/webmproject/libwebp.git
    ...
    CC=chibicc CFLAGS="-fpic" LDFLAGS="-fpic -lpng -ljpeg -lwebp" cmake -S . -B ./build
    cd build
    cmake --build .
