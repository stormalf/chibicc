...
1.0.23    Activating GNUC macros. Fixing issue with curl test due to duplicate "case" value not detected. Fixing issue with va_area (reporting changes from @fuhsnn in commit 174da1a).
