...
temp stack from widcc/slimcc (@fuhsnn) but still an issue with some structs in variadic with alignment > 16. Fixing issue with bitfield (using fixes from widcc @fuhsnn).
